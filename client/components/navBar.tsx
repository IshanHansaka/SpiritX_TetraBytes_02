    ...
    <nav className="bg-white shadow-md p-4">
      ...
      {isOpen && (
        <div className="md:hidden flex flex-col space-y-4 mt-4">
          ...
          <Link href="/about" className="text-black hover:text-blue-600">Player Stats</Link>
          <Link href="/contact" className="text-black hover:text-blue-600">Tournament Summary</Link>
          <button className="bg-red-600 text-white px-4 py-2 rounded-md border border-red-600 transition-all duration-300 hover:bg-transparent hover:text-red-600">
            Log Out
          </button>
